export declare const subjects: readonly ["kana_vocabulary", "kanji", "radical", "vocabulary"];
export declare const audioTypes: readonly ["audio/mpeg", "audio/ogg"];
...
export declare const voiceActorGenders: readonly ["male", "female"];
export declare const singularResourceTypes: readonly ["assignment", "kana_vocabulary", "kanji", "level_progression", "radical", "reset", "review_statistic", "review", "spaced_repetition_system", "study_material", "user", "vocabulary", "voice_actor"];
export declare const objectTypes: readonly ["collection", "report"];
export declare const baseURL = "https://api.wanikani.com/v2/";
