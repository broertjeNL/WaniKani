...
const spaced_repetition_systems_utils_1 = require("./spaced-repetition-systems-utils");
const mockSrs = {
...
describe('spaced-repetition-systems-utils', () => {
    describe('getIntervalInSeconds', () => {
        ...
        `('should $result given $stage', ({ stage, result }) => {
            expect((0, spaced_repetition_systems_utils_1.getIntervalInSeconds)(stage)).toBe(result);
        });
    });
});
