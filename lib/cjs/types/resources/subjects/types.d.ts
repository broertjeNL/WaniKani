...
export type SubjectCollectionApiResponse<T extends _Subjects = _Subjects, U extends SubjectType = SubjectType> = CollectionApiResponse<SubjectResourceApiResponse<T, U>>;
 ...
 */
export type SubjectData<T extends RadicalAttributes | KanjiAttributes | VocabularyAttributes | KanaVocabularyAttributes> = {
    /**
